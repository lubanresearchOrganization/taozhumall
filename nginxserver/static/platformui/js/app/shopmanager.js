var shopmanager = (function ($, lajaxComponent) {
    ...
    index.del = function (data) {
        ...
        if (confirm(msg) == true) {
            ...
            lajaxComponent.deleteNoParamReturnText(config.baseUrl + "/v/0.1/shops/"+data, function (result) {
    ...
    index.init = function () {
        ...
        lajaxComponent.getNoParamReturnJson(config.baseUrl + "/v/0.1/shops/", function (data) {
